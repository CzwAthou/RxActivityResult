...
inline fun <reified T : Activity> Context.startActivityWithResult(vararg params: Pair<String, Any>): Observable<Result>
        = RxActivityResult.with(this).putAll(Bundle().pair(params)).startActivityWithResult(Intent(this, T::class.java))
